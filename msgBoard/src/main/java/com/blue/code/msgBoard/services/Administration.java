...
@GetMapping("/branch/edit/{code}")
public String sendEditConfirmation(@PathVariable("code") int code,Model model)
{
try
{
BranchDAO branchDAO=new BranchDAO();
...
model.addAttribute("title",branches.get(i).getTitle());
}
}
}catch(Exception exception)
{
...
return "BranchConfirmation";
}
@GetMapping("/branch/delete/{code}")
public String sendDeleteConfirmation(@PathVariable("code") int code,Model model)
{
try
{
BranchDAO branchDAO=new BranchDAO();
...
public String confirmEdit(@RequestParam("code") int code,@RequestParam("title") String title,Model model)
{
try
{
BranchBean branchBean=new BranchBean();
branchBean.setCode(code);
branchBean.setTitle(title);
System.out.println(code);
System.out.println(title);
System.out.println("inside confirm Edit");
BranchDAO branchDAO=new BranchDAO();
branchDAO.updateBranch(branchBean);
}catch(Exception exception)
{
...
public String confirmDelete(@RequestParam("code") int code,@RequestParam("title") String title)
{
try
{
BranchBean branchBean=new BranchBean();
